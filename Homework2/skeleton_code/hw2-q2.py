...
class CNN(nn.Module):
    ...
    def __init__(self, dropout_prob, no_maxpool=False):
        ...
        if not no_maxpool:
            ...
            self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=3, padding=1, stride=2)
            self.conv2 = nn.Conv2d(in_channels=8, out_channels=16, kernel_size=3, padding=0, stride=2)
